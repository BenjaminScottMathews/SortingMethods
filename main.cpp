...
void printList(const vector<int> &myList);
...
void manualInput(vector<int> &mainList)
{
    ...
    cout << endl;
    cout << "Please list numbers <= 1000 for your list." << endl;
...
void callSort(vector<int> &mainList)
{
    ...
    cout << "Print Counting Sorted: 'printC'" << endl;
    cout << "Print Radix Sorted: 'printR'" << endl;
    ...
    while (cin >> inputSort)
    {
        ...
        else if (inputSort == "counting")
        {
            countingVector = countingSort(mainList);
        }
        else if (inputSort == "radix")
        {
            radixVector = radixSort(mainList);
        }
        ...
        else if (inputSort == "printC")
        {
            if (countingVector.empty()) {cout << "Please sort first" << endl;}
            else {printList(countingVector);}
        }
        else if (inputSort == "printR")
        {
            if (radixVector.empty()) {cout << "Please sort first" << endl;}
            else {printList(radixVector);}
        }
